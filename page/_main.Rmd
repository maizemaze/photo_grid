...
<!--chapter:end:03-PlotExtraction.Rmd-->


<!--chapter:end:04-CenterPoints.Rmd-->
...
## Mac OS users
1. Download [iPat_Installer.dmg](http://zzlab.net/iPat/iPatMac.zip) and mount it on Mac.
...
<!--chapter:end:xxGettingStart.Rmd-->
